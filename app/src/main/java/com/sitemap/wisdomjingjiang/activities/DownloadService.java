...
import com.sitemap.wisdomjingjiang.activities.NotificationUpdateActivity.ICallbackResult;
...
//	 private String apkUrl = "http:\/\/www.na2ne.com:20015\/NaErNe\/apk\/Na2Ne.apk";
	...
	private static final String saveFileName = savePath + "jingjiang.apk";//apk名字
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name, "jingjiang.apk 正在下载...");
		// 指定个性化视图
