 ...
 *	酒店页面
 */
public class HotleActivity extends BaseActivity implements OnClickListener{
	/**全局类*/ 
	...
	private void initView() {
		...
		mLv = (ListView) findViewById(R.id.hotle_listview);
	}
			...
			public void onRefresh(PullToRefreshLayout pullToRefreshLayout) {
				...
				if (MyApplication.getNetObject().isNetConnected()) {
					http.sendGet(
							...
							WebUrlConfig.getHotelShops(String.valueOf(MyApplication.lng),String.valueOf(MyApplication.lat),String.valueOf(0)));
				} else {
			...
			public void onLoadMore(PullToRefreshLayout pullToRefreshLayout) {
				if (MyApplication.getNetObject().isNetConnected()) {
					http.sendGet(
							...
							WebUrlConfig.getHotelShops(String.valueOf(MyApplication.lng),String.valueOf(MyApplication.lat),String.valueOf(page)));
				} else {
...
//		mLv.setAdapter(new HotleListViewAdapter(mContext));
