...
import com.sitemap.wisdomjingjiang.views.NewsFragmentActivity.TabInfo;
...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        mTextColorSelected= a.getColorStateList(R.styleable.TitleIndicator_textColor);
    ...
    protected void add(int index, String label, int icon, boolean hasTips) {
        View tabIndicator;
        if (index < 2) {
            tabIndicator = mInflater.inflate(R.layout.title_flow_news, this, false);
        } else {
            tabIndicator = mInflater.inflate(R.layout.title_flow_news_v2, this, false);
        }
