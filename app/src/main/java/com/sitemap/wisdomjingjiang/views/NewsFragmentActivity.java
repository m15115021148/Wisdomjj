...
public abstract class NewsFragmentActivity extends FragmentActivity implements OnPageChangeListener {
    ...
    public class MyAdapter extends FragmentPagerAdapter {
        ...
        @Override
        public NewsFragment getItem(int pos) {
    ...
    protected int getMainViewResId() {
        return R.layout.activity_titled_fragment_tab;
    }
    ...
    public static class TabInfo implements Parcelable {
        ...
        public NewsFragment fragment = null;
        public boolean notifyChange = false;
        @SuppressWarnings("rawtypes")
        public Class fragmentClass = null;

        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, NewsFragment fragment) {
            this(id, name, 0, fragment);
        }

        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, boolean hasTips, NewsFragment fragment) {
            this(id, name, 0, fragment);
            this.hasTips = hasTips;
        }

        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, int iconid,NewsFragment fragment) {
            super();
